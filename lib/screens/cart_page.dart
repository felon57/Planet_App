...
// - Receives a list of plants currently added to cart (addedToCartPlants).
// - Renders each selected item and computes the total price dynamically.
// - If the cart is empty, shows an empty-state illustration and message.
                        ...
                        children: [
                          Row(
                            children: [
                              ...
                              Text(
                                widget.addedToCartPlants.fold<int>(0, (s, p) => s + p.price).toString().farsiNumber,
                                style: TextStyle(
                                  fontFamily: 'Lalezar',
